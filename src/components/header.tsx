  ...
  return (
    <div className="flex flex-wrap items-center gap-2 justify-center md:justify-between border px-6 py-4 sticky top-0 z-50 max-w-6xl mx-auto bg-background">
      ...
      <div className="flex flex-wrap justify-center items-center gap-1">
        <a
          href="https://www.producthunt.com/products/the-radar-project?embed=true&utm_source=badge-featured&utm_medium=badge&utm_source=badge-the&#0045;radar&#0045;project"
          target="_blank"
        >
          <Image
            src="https://api.producthunt.com/widgets/embed-image/v1/featured.svg?post_id=1010730&theme=dark&t=1756463497614"
            alt="The&#0032;Radar&#0032;Project - Discover&#0032;the&#0032;next&#0032;rising&#0032;stars&#0032;with&#0032;AI&#0045;powered&#0032;insights&#0046; | Product Hunt"
            ...
            <DialogHeader>
              ...
              <DialogDescription asChild>
                <div className="space-y-2">
                  <p>
                    Have questions, want to report discrepancies or dislikes, or
                    are you a promotion/sponsor looking to get in touch?
