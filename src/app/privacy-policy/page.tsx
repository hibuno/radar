...
export const metadata: Metadata = {
  title: "Privacy Policy - The Radar Project",
  description:
    "Privacy Policy for The Radar Project. Learn how we collect, use, and protect your personal information when you use our platform.",
  keywords: [
    "privacy policy",
    "data protection",
    "privacy",
  ...
  openGraph: {
    title: "Privacy Policy - The Radar Project",
    description:
      "Privacy Policy for The Radar Project. Learn how we collect, use, and protect your personal information.",
    url: "/privacy-policy",
    ...
    images: [
      {
        ...
        width: 1200,
        height: 630,
        alt: "Privacy Policy - The Radar Project",
      },
    ],
  },
  twitter: {
          ...
          <div className="prose prose-lg max-w-none">
            ...
            <section className="mb-8">
              ...
              <p className="text-muted-foreground leading-relaxed mb-4">
                We may collect information you directly provide to us,
                including:
              </p>
              <ul className="list-disc list-inside text-muted-foreground space-y-2 mb-4">
                <li>Contact information when you reach out to us</li>
                <li>
                  Feedback, suggestions, or other communications you send us
                </li>
                <li>
                  Information provided when participating in surveys or
                  promotions
                </li>
              </ul>
              ...
              <ul className="list-disc list-inside text-muted-foreground space-y-2 mb-4">
                <li>
                  ...
                  visited, time spent on pages, click patterns, and navigation
                  paths
                </li>
                <li>
              ...
              <p className="text-muted-foreground leading-relaxed">
                We aggregate and display public information from third-party
                sources including GitHub, OSS Insight, and Hugging Face. This
                data is publicly available and does not include personal
            ...
            <section className="mb-8">
              ...
              <p className="text-muted-foreground leading-relaxed mb-4">
                We use DataBuddy analytics to understand how visitors interact
                with our website. This helps us improve our services and user
                experience. DataBuddy collects information about:
              </p>
              <ul className="list-disc list-inside text-muted-foreground space-y-2 mb-4">
              ...
              <p className="text-muted-foreground leading-relaxed">
                ...
                website. For more information about DataBuddy and how to opt
                out, please visit their privacy policy.
              </p>
            </section>
            ...
            <section className="mb-8">
              ...
              <ul className="list-disc list-inside text-muted-foreground space-y-2">
                ...
                <li>
                  <strong className="text-foreground">Consent:</strong> With
            ...
            <section className="mb-8">
              ...
              <p className="text-muted-foreground leading-relaxed">
                ...
                longer retention period is required by law. Analytics data
                collected through DataBuddy is retained according to their
                retention policies.
              </p>
            </section>
