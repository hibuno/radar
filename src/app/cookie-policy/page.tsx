...
export const metadata: Metadata = {
  title: "Cookie Policy - The Radar Project",
  description:
    "Cookie Policy for The Radar Project. Learn about how we use cookies and similar technologies on our platform.",
  keywords: [
    "cookie policy",
    "cookies",
    "privacy",
  ...
  openGraph: {
    title: "Cookie Policy - The Radar Project",
    description:
      "Cookie Policy for The Radar Project. Learn about how we use cookies and similar technologies.",
    url: "/cookie-policy",
    ...
    images: [
      {
        ...
        width: 1200,
        height: 630,
        alt: "Cookie Policy - The Radar Project",
      },
    ],
  },
  twitter: {
          ...
          <div className="prose prose-lg max-w-none">
            ...
            <section className="mb-8">
              ...
              <p className="text-muted-foreground leading-relaxed">
                ...
                preferences, improve user experience, and provide analytics
                about how the site is used. Cookies can be set by the website
                you&apos;re visiting (first-party cookies) or by third-party
                services integrated into the website (third-party cookies).
              </p>
            </section>
            ...
            <section className="mb-8">
              ...
              <p className="text-muted-foreground leading-relaxed mb-4">
                The Radar Project uses cookies and similar technologies to:
              </p>
            ...
            <section className="mb-8">
              ...
              <ul className="list-disc list-inside text-muted-foreground space-y-2 mb-4">
                ...
                <li>
                  ...
                  Protect against cross-site request forgery and other security
                  threats
                </li>
              </ul>
              ...
              <p className="text-muted-foreground leading-relaxed mb-4">
                We use DataBuddy, a privacy-focused analytics service, to
              ...
              <ul className="list-disc list-inside text-muted-foreground space-y-2 mb-4">
                ...
                <li>
                  <strong className="text-foreground">Feature Cookies:</strong>{" "}
                  Enable specific website features you&apos;ve requested
                </li>
              </ul>
              ...
              <p className="text-muted-foreground leading-relaxed">
                We may integrate third-party services that set their own
              ...
              <ul className="list-disc list-inside text-muted-foreground space-y-2">
                ...
                <li>
                  ...
                  hosting platform may set performance and security cookies
                </li>
                <li>
            ...
            <section className="mb-8">
              ...
              <ul className="list-disc list-inside text-muted-foreground space-y-2">
                ...
                <li>
                  ...
                  Retained according to DataBuddy&apos;s retention policies
                </li>
              </ul>
            </section>
            ...
            <section className="mb-8">
              ...
              <div className="bg-muted p-4 rounded-lg mb-4">
                <p className="text-muted-foreground text-sm">
                  ...
                  <br />
                  <strong className="text-foreground">Edge:</strong> Settings →
              ...
              <p className="text-muted-foreground leading-relaxed">
                You can opt out of DataBuddy analytics tracking by visiting
                their privacy settings or by using browser extensions that block
                analytics cookies. Please note that opting out may affect the
            ...
            <section className="mb-8">
              ...
              <p className="text-muted-foreground leading-relaxed">
                While you can browse our website without cookies, disabling them
            ...
            <section className="mb-8">
              ...
              <ul className="list-disc list-inside text-muted-foreground space-y-2">
                <li>
                  ...
                  Small graphic images that track page views and email opens
                </li>
                <li>
                  <strong className="text-foreground">Local Storage:</strong>{" "}
                  Browser storage for saving user preferences
                </li>
                <li>
                  <strong className="text-foreground">Session Storage:</strong>{" "}
                  Temporary browser storage for session data
                </li>
              </ul>
            </section>
            ...
            <section className="mb-8">
              ...
              <p className="text-muted-foreground leading-relaxed">
                We may share cookie data with trusted third-party service
                providers who assist us in operating our website and analyzing
                usage. These partners are contractually obligated to maintain
                the confidentiality and security of your data. We do not sell
                cookie data to third parties for marketing purposes.
              </p>
            </section>
            ...
            <section className="mb-8">
              ...
              <p className="text-muted-foreground leading-relaxed">
                ...
                We do not knowingly collect personal information through cookies
                from children under 13. If we become aware that we have
                collected cookie data from a child under 13, we will take steps
                to delete such data.
              </p>
            </section>
