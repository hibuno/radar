...
export const metadata: Metadata = {
  title: "Terms of Service - The Radar Project",
  description:
    "Terms of Service for The Radar Project. Please read these terms carefully before using our platform for discovering trending repositories.",
  keywords: [
    "terms of service",
    "terms",
    "legal",
  ...
  openGraph: {
    title: "Terms of Service - The Radar Project",
    description:
      "Terms of Service for The Radar Project. Please read these terms carefully before using our platform.",
    ...
    images: [
      {
        ...
        width: 1200,
        height: 630,
        alt: "Terms of Service - The Radar Project",
      },
    ],
  },
  twitter: {
          ...
          <div className="prose prose-lg max-w-none">
            ...
            <section className="mb-8">
              ...
              <p className="text-muted-foreground leading-relaxed">
                Welcome to The Radar Project (&ldquo;we,&rdquo;
            ...
            <section className="mb-8">
              ...
              <p className="text-muted-foreground leading-relaxed mb-4">
                The Radar Project is a platform that provides:
              </p>
              <ul className="list-disc list-inside text-muted-foreground space-y-2">
                <li>
                  Discovery and exploration of trending GitHub repositories
                </li>
                <li>
                  Information about rising star projects and developer tools
                </li>
              ...
              <p className="text-muted-foreground leading-relaxed mt-4">
                Our Service aggregates publicly available information from
                various sources including GitHub, OSS Insight, and Hugging Face.
              </p>
            </section>
            ...
            <section className="mb-8">
              ...
              <ul className="list-disc list-inside text-muted-foreground space-y-2">
                ...
                <li>
                  Not use automated tools to access the Service without
                  permission
                </li>
                <li>
                ...
                <li>
                  Not use the Service to transmit harmful, offensive, or illegal
                  content
                </li>
              </ul>
            </section>
            ...
            <section className="mb-8">
              ...
              <p className="text-muted-foreground leading-relaxed mb-4">
                ...
                functionality are owned by The Radar Project and are protected
              ...
              <p className="text-muted-foreground leading-relaxed">
                The Service displays content from third-party sources (GitHub,
                OSS Insight, Hugging Face). This content is subject to the
                respective owners&apos; intellectual property rights. We do not
                claim ownership of third-party content and are not responsible
                for its accuracy or legality.
              </p>
            </section>
            ...
            <section className="mb-8">
              ...
              <p className="text-muted-foreground leading-relaxed">
                Our Service may allow you to submit feedback, suggestions, or
                other content. By submitting content, you grant us a
                non-exclusive, royalty-free, perpetual, and worldwide license to
                use, modify, and distribute your content in connection with our
                Service. You represent that you own or have the necessary rights
            ...
            <section className="mb-8">
              ...
              <p className="text-muted-foreground leading-relaxed mb-4">
                ...
                information displayed, we do not guarantee that all content is
                current, complete, or error-free. Repository information and
            ...
            <section className="mb-8">
              ...
              <p className="text-muted-foreground leading-relaxed">
                To the maximum extent permitted by law, The Radar Project shall
            ...
            <section className="mb-8">
              ...
              <p className="text-muted-foreground leading-relaxed">
                You agree to indemnify and hold harmless The Radar Project, its
            ...
            <section className="mb-8">
              ...
              <p className="text-muted-foreground leading-relaxed">
                ...
                exclusive jurisdiction of the courts in Indonesia.
              </p>
            </section>
            ...
            <section className="mb-8">
              ...
              <p className="text-muted-foreground leading-relaxed">
                ...
                Radar Project regarding the use of the Service and supersede all
